...
**Date:** 2026-05-23
**Authoritative dependencies:** Constitution v0.10.0-draft, Canonical Encoding Specification v1.3 (SCF), DSL Specification v0.1.0-draft.
**License:** MIT.
...
This specification and all reference implementations of CAL Execution v0.1.0-draft are released under the **MIT license** (see `LICENSE` in `paradigm_terra/promt/`). License terms align with Canonical Encoding §12, Constraint DSL §10, and Constitution §16.1.
