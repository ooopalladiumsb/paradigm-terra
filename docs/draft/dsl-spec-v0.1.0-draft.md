...
**Authoritative dependencies:** Constraint DSL v1.1, CAL Execution Specification v0.1.0-draft, Canonical Encoding v1.3 (Consensus-Freeze), Constitution v0.10.0-draft.
**License:** MIT.
...
This specification and all reference implementations of DSL v1.2 are released under the **MIT license** (see `LICENSE` in the repository root). License terms align with Canonical Encoding §12, Constraint DSL v1.1 §10, CAL Execution Spec §15, and Constitution §16.1.
