...
.PHONY: setup freeze-check verify-proof verify-proof-ts verify-proof-go parity parity-ts parity-rs parity-go vectors-check bench help

help setup freeze-check verify-proof verify-proof-ts verify-proof-go parity parity-ts parity-rs parity-go vectors-check bench:
	@scripts/repro.sh $@
