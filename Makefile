...
.PHONY: setup typecheck freeze-check verify-proof verify-proof-ts verify-proof-go parity parity-ts parity-rs parity-go vectors-check bench m2-registry pp2 tolk help

help setup typecheck freeze-check verify-proof verify-proof-ts verify-proof-go parity parity-ts parity-rs parity-go vectors-check bench m2-registry pp2:
	@scripts/repro.sh $@
