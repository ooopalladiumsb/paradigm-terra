...
const CONTRACTS = ["example-counter.tolk", "registry.tolk", "treasury.tolk", "failure-state.tolk", "capability.tolk", "anchor-index.tolk", "governance-view.tolk", "oracle-view.tolk"];
