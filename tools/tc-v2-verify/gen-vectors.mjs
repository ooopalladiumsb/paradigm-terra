...
fs.writeFileSync(path.join(OUT, 'manifest.json'), JSON.stringify({
  ...
  version: '0.1.0',
  status: 'NORMATIVE',
  description: 'Golden conformance vectors for the two TC v2 owner-signature contracts. NORMATIVE (promoted 2026-06-01, Exec-spec §8.4 Tier-2 amendment); TS/Rust/Go cross-language parity green. See docs/spec/tc-v2-sig-verify-v1.md.',
  contracts: {
